...
export default async function ConfiguracoesPage() {
  ...
  const pode = usuarioAtual ? permissoesDe(usuarioAtual) : null;
      ...
      {pode?.gerenciarEquipe && (
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-medium text-text">Equipe</p>
              <p className="text-xs text-muted">
                Login de cada pessoa, com o que ela pode ver e fazer — abas, valores e clientes.
              </p>
            </div>
          </div>
          <ChevronRight size={16} className="text-muted" />
